...
**C29 — "THE PP GEOMETRY IS QUANTISED AT FOUR LAYERS" AND "THE RIG CANNOT BE
...
**The law this produces (law 21).** *A lever that looks quantised may be
...
21. **A lever that looks quantised may be quantised by the SOLVER, not by
   the hardware** (C29, #485). The PP layer knob was recorded as steppable
