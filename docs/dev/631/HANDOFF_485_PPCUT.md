...
`CONTRADICTIONS_REGISTER.md` (C33, law 22 — renumbered from this strand's
independently-assigned C29/law 21 at merge time by successor 48, because the
flip line had already used both numbers: its C29 is the restore margin and its
law 21 is the instrument-floor law).
