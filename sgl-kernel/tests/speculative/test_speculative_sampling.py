...
test_cases = [
    ...
    (
        0,  # threshold_single
        0,  # threshold_acc
        # Upstream #35798: zero-mass drafts are no longer accepted at
        # threshold 0/0, so this case now matches the 1/1 one.
        [3, -1, -1, 4, 5, 18, 11, -1, -1, -1, 12, 18],
        [[0, 3, 4, 5], [6, 10, 11, -1]],
        [3, 2],
    ),
...
def test_target_only_sampling_cdf_boundaries(
    ...
    """Upstream #35798 (needs the rebuilt sgl_kernel)."""
