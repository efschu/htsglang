...
# #1233 (WEG 2, S0): the channel taxonomy moved to ``pp_wire_channels`` --
# a module that survives, because the PP loop names its wires with these
# constants independently of any layout change. Re-exported here so this
# module's own readers keep working until S7 deletes it. ONE DEFINITION.
from sglang.srt.managers.pp_wire_channels import (  # noqa: E402,F401
    CHAN_DICT,
    CHAN_PASS,
    CHAN_REQ,
    CHAN_SLOT,
