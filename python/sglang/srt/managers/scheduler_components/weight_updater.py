    ...
    def _weg2_shadow_hook(self, hook: str, *, recv_req, reserve_bytes: int = 0,
        ...
        try:
            ...
            inputs = sh.ShadowLegInputs(
                ...
                # refused leg prints (W79 ``no-plan``) says WHY the pair could
                ...
                # of the W80 plan divergence.  The root is one missing argument.
                ...
                # NAME -- W81 on the ``host`` arm when the slots or the #1269
