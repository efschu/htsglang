...
if _is_cuda or _is_hip:
    # Turing (sm75) / gfx900: CUDA-or-ROCm is necessary but not sufficient --
    # sgl-kernel is cubin-only with a gencode floor of sm_80 and has no ROCm
    # build below gfx942, so these HiCache transfer kernels are absent there.
    # This module is on the ordinary startup path; HiCache itself still needs
    # them.
    try:
