...
RTX 3080 W4A8 (user order 25.09. ~17:33Z: sm_8x under native-mixed ALWAYS W4A8): window wgbsqk
(2026-09-25 16:02-16:14Z, NVML 0, 230 W), raw data /spinning/evidence-665-f1/n4d_decode_0925/q4.json, the
serving apply path at M=512 (nvfp4_w4a8_linear = per-token INT8 quant + N4A GEMM), same FLOP definition; the
same run measured Marlin at 3231.18 + 1694.36 us = 55.6 TFLOPS, i.e. it reproduces the zcx7pv Marlin value:
...
SOURCE = "record zcx7pv+wgbsqk 2026-09-25 M=512 (5090 400 W, 3080 230 W)"

#: card-name substring -> {lane: TFLOPS}
LANES: Dict[str, Dict[str, float]] = {
    "RTX 5090": {"nvfp4_native": 805.4, "nvfp4_marlin": 212.4},
    "RTX 3080": {"nvfp4_w4a8": 62.7, "nvfp4_marlin": 55.4},
}
