...
def _layer_norm_fwd_1pass_kernel(
    ...
    if HAS_Z and not NORM_BEFORE_GATE:
        if Z_IS_3D:
            # Upstream #36267: z is a strided [T, H, D] view of the projection
            # output; row r of x is (token r // H, head r % H).
    ...
    *,
    ...
    if z is not None:
        if z.shape == x_shape_og:
            ...
            # Upstream #36267: a strided [T, H, D] gate against x [T*H, D] is
            # read in place (no .contiguous() copy of z per GDN layer).
