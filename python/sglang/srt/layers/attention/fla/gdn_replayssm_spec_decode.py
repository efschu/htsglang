...
Fork port (27B ReplaySSM slice S1): taken verbatim from upstream main
(sglang/kernels/ops/attention/fla/gdn_replayssm_spec_decode.py, chain #28695 ->
...
from sglang.srt.layers.attention.fla.utils import is_tf32_supported
