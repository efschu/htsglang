...
def _hc_param_device() -> Optional[int]:
    """Device for the Gated Residual projections, or None for the ambient one.

    FORK-LOCAL DELTA vs upstream qwen4-main-squashed, which hardcodes
    ``device=torch.cuda.current_device()``. That call RAISES
