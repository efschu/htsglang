...
def init_staging_buffers(
    ...
    a chunk can never be too large for the buffer. ``register_fn`` must either
    raise on failure or return a status of None / 0 / True on success; any other
    return value is treated as a registration failure.
    """
