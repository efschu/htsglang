...
class TestProbeArming(unittest.TestCase):
    ...
    def test_armed_when_env_set(self):
        ...
        k_max = max(resolve_candidate_steps_from_config(None, algorithm="EAGLE"))
        self.assertEqual(w.survival_probe.k_max, k_max)
        self.assertEqual(w.survival_probe.buffer.shape, (4, k_max))
