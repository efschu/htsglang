...
NAMED_POST_SPAWN_HELPERS = (
    ...
    # 27B line (24.09.): the W10 grader is gate_w10 since 853c448693 (it
    # calls check_drafter_identity and raises W10 itself, skipped by name
    # under --dflash-produce-on-p off); main() no longer calls
