...
def _argv_p():
    return L.argv_p(
        ...
        # UNIFY S6: the unified argv_p takes P's producer flags as a keyword
        # (the NF form); under DFLASH they are spec_flags(producer=True). Same
        # flags, same identity question as on the 27B line.
